...
export class Environment extends Entity {
  ...
  public static hydrate(environmentAsObject: any): Environment {
    ...
    environment.userName = environmentAsObject._userName
    environment.password = environmentAsObject._password;
    ...
    if (textToken.type == TokenType.Property) {
      ...
      switch (propertyName) {
        ...
        case "useragent":
          ...
          break;
        case "username":
          this.userName = textToken.propertyValueToken.text;
          break;
        case "password":
          this.password = textToken.propertyValueToken.text;
          break;
      }
    }
  }
